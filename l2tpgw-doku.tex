% arara: lualatex: { shell: yes, synctex: yes, options: "-output-directory=_build", action: nonstopmode}
% arara: lualatex: { shell: yes, synctex: yes, options: "-output-directory=_build", action: nonstopmode}
...
\setmainfont{helveticaneue.ttf}
\setsansfont{helveticaneue.ttf}
\setmonofont{helveticaneue.ttf}
